  ...
  <div v-show="!responseOK" class="my-3 text-black">
    <Form @submit="Submit(t('lang'))">
      ...
      <div class="justify-center">
        <button class="text-white font-semibold border border-vue-green rounded-sm shadow-lg w-24 p-2 justify-center bg-vue-green inline-flex items-center hover:bg-gradient-to-r from-emerald-600" type="submit" :disabled="disabled">
...
// TODO: https://stackoverflow.com/questions/63100658/add-global-variable-in-vue-js-3
const { t } = useI18n({
  inheritLocale: true,
  useScope: 'local'
})
...
const Submit = async (lang) => {
  disabled.value = true
  // FIXME: BUG IN DATE PICKER CONVERTION
